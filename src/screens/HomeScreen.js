  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView stickyHeaderIndices={[0]} showsVerticalScrollIndicator={true}>
          ...
          <View style={styles.addressView}>
            <View
              ...
              <Icon
                ...
                size={26}
              />
              <Text style={{marginLeft: 5}}>송파</Text>
            </View>
            ...
            <View style={styles.clockView}>
              <Icon
                ...
                size={26}
              />
              <Text style={{marginLeft: 5}}>지금</Text>
            </View>
          </View>
        ...
        <View style={styles.headerTextView}>
          <Text style={styles.headerText}>지금만 무료배달</Text>
        </View>
        ...
        <View style={styles.headerTextView}>
          <Text style={styles.headerText}>프로모션 진행중</Text>
        </View>
        ...
        <View style={styles.headerTextView}>
          <Text style={styles.headerText}>나와 가장 가까운 곳은 요기</Text>
        </View>
